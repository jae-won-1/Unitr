    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen px-6 pb-20">
        ...
        <p className="text-sm text-text-secondary text-center mb-6">
          We&apos;ll review your venue and get in touch at <span className="text-accent">{form.contact_email}</span> within 2 working days.
        </p>
        <a href="/pitches" className="px-6 py-3 rounded-xl bg-accent text-black font-bold text-sm">
          Browse Pitches
        </a>
      </div>
    );
  ...
  return (
    <div className="flex flex-col min-h-screen pt-12 pb-28 px-4">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-xl font-bold">Register Your Pitch</h1>
      ...
      <div className="space-y-5">
        ...
        <div className="bg-surface-2 border border-border rounded-2xl p-4 space-y-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-medium">Venue Name <span className="text-red-400">*</span></label>
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-medium">Address <span className="text-red-400">*</span></label>
        ...
        <div className="bg-surface-2 border border-border rounded-2xl p-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-medium">Price / Hour (£) <span className="text-red-400">*</span></label>
        ...
        <div className="bg-surface-2 border border-border rounded-2xl p-4 space-y-3">
          <p className="text-xs font-semibold text-text-secondary uppercase tracking-wider">Match Formats <span className="text-red-400">*</span></p>
        ...
        <div className="bg-surface-2 border border-border rounded-2xl p-4 space-y-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-medium">Contact Email <span className="text-red-400">*</span></label>
      ...
      {/* Submit button */}
      <div className="fixed bottom-16 left-0 right-0 px-4 pt-3 pb-3 bg-[#0e0e0e] border-t border-border">
        <button
