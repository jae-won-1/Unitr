  ...
  return (
    <div className="space-y-4">
      <div className="bg-surface border border-border rounded-btn px-4 py-3 text-xs space-y-1.5">
        ...
        <div className="flex justify-between text-text-secondary"><span>New balance</span><span className="font-bold text-accent-ink">£{(currentPence / 100 + amount).toFixed(2)}</span></div>
      </div>
            ...
            {!clientSecret ? (
              <>
                ...
                {effectiveAmount && effectiveAmount >= 1 && (
                  <div className="bg-surface border border-border rounded-btn px-3 py-2.5 mb-4 text-xs space-y-1">
                    ...
                    <div className="flex justify-between text-text-secondary"><span>New balance</span><span className="font-semibold text-accent-ink">£{(currentPence / 100 + effectiveAmount).toFixed(2)}</span></div>
                  </div>
                )}
